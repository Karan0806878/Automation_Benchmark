...
Given('User is on NH Application Home Page test Resource Group Total', async () => {
...
When('User Navigates to Project Detail Screen to create Resource Group Total', async () => {
...
When('User Add a Resource Group Total', async () => {
     ...
     await pageFixture.page.locator('(//span[normalize-space(text())="Maintenance"]/following::input)[3]').click();
      ...
      await pageFixture.page.waitForTimeout(2000);
      await pageFixture.page.locator('//span[normalize-space(text())="Resource Group Total"]').click();
    ...
    When('User Update a Resource Group Total', async () => {
      const randomStr = generateRandomString(10);
    ...
    When('User Delete a Resource Group Total', async () => {
      const randomStr = generateRandomString(10);
