...
Given('User is on NH Application Home Page test Resource Production Rate', async () => {
...
When('User Navigates to Project Detail Screen to create Resource Production Rate', async () => {
...
When('User Add a Resource Production Rate', async () => {
     ...
     await pageFixture.page.locator('(//span[normalize-space(text())="Maintenance"]/following::input)[3]').click();
      ...
      await pageFixture.page.waitForTimeout(2000);
      await pageFixture.page.locator('//span[normalize-space(text())="Resource Production Rate"]').click();
      ...
      await pageFixture.page.locator('(//input[@class="dx-texteditor-input"])[2]').fill('4');
      ...
      await pageFixture.page.locator('//label[normalize-space(text())="Production Rate Group"]/following::input').click();
      await pageFixture.page.locator('//label[normalize-space(text())="Production Rate Group"]/following::input').fill('4');
      await pageFixture.page.waitForTimeout(1000);
    ...
    When('User Update a Resource Production Rate', async () => {
      const randomStr = generateRandomString(10);
      ...
      await pageFixture.page.waitForTimeout(1000);
      await pageFixture.page.locator('(//label[normalize-space(text())="Description"]/following::textarea)[1]').fill('Retest to testing');
      await pageFixture.page.locator('(//input[@class="dx-texteditor-input"])[2]').click();
      await pageFixture.page.locator('(//input[@class="dx-texteditor-input"])[2]').clear();
      await pageFixture.page.locator('(//input[@class="dx-texteditor-input"])[2]').fill('20');

      await pageFixture.page.locator('(//div[@class="dx-dropdowneditor-icon"])[2]').click();
      await pageFixture.page.locator('//div[normalize-space(text())="Bags"]').click();
      await pageFixture.page.locator('//label[normalize-space(text())="Production Rate Group"]/following::input').click();
      await pageFixture.page.locator('//label[normalize-space(text())="Production Rate Group"]/following::input').clear();
      await pageFixture.page.locator('//label[normalize-space(text())="Production Rate Group"]/following::input').fill('12');
      await pageFixture.page.waitForTimeout(1000);
      await pageFixture.page.locator('//label[normalize-space(text())="Text"]/following::textarea').click();
      await pageFixture.page.locator('//label[normalize-space(text())="Text"]/following::textarea').clear();
      await pageFixture.page.locator('//label[normalize-space(text())="Text"]/following::textarea').fill('Retest Read');
      await pageFixture.page.waitForTimeout(1000);
      await pageFixture.page.locator('//span[normalize-space(text())="Save"]').click();
      await pageFixture.page.waitForTimeout(4000);
    ...
    When('User Delete a Resource Production Rate', async () => {
      const randomStr = generateRandomString(10);
