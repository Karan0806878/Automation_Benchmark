...
Given('User is on NH Application Home Page test Composite Item', async () => {
...
When('User Navigates to Project Detail Screen to create Composite Item', async () => {
...
When('User Add a Composite Item', async () => {
    ...
    await pageFixture.page.locator('//span[normalize-space(text())="Composite Item"]').click();
    ...
    await pageFixture.page.locator('(//label[normalize-space(text())="Item Description"]/following::textarea)[1]').fill("Item Test");
    await pageFixture.page.waitForTimeout(1000);
    ...
    When('User Update a Composite Item', async () => {
      const randomStr = generateRandomString(10);
    ...
    await pageFixture.page.locator('(//div[@class="dx-datagrid-group-closed"])[2]').click();
    await pageFixture.page.locator('(//div[@class="dx-datagrid-group-closed"])[2]').click();
      await pageFixture.page.waitForTimeout(1000);
    ...
    When('User Duplicate a Composite Item', async () => {
      const randomStr = generateRandomString(10);
    ...
    When('User Delete a Composite Item', async () => {
      const randomStr = generateRandomString(10);
