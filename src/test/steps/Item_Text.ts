...
Given('User is on NH Application Home Page test Item Text', async () => {
...
When('User Navigates to Project Detail Screen to create Item Text', async () => {
...
When('User Add a Item Text', async () => {
     ...
     await pageFixture.page.locator('//span[normalize-space(text())="Text"]').click();
     ...
     await pageFixture.page.locator('(//label[normalize-space(text())="Item Description"]/following::textarea)[1]').fill("Item Text Test");
     await pageFixture.page.waitForTimeout(1000);
     await pageFixture.page.locator('//label[normalize-space(text())="Item Text"]/following::textarea').click();
     await pageFixture.page.locator('//label[normalize-space(text())="Item Text"]/following::textarea').fill("Item Text");
     await pageFixture.page.waitForTimeout(1000);
    ...
    When('User Update a Item Text', async () => {
        const randomStr = generateRandomString(10);

        await pageFixture.page.locator('(//div[@class="dx-button-content"]//i)[2]').click();
        await pageFixture.page.waitForTimeout(1000);
        await pageFixture.page.locator('(//span[normalize-space(text())="Operations & Maintenance"]/following::input)[3]').click();
        await pageFixture.page.locator('(//span[normalize-space(text())="Operations & Maintenance"]/following::input)[3]').fill('ABC');
        await pageFixture.page.waitForTimeout(1000);
        await pageFixture.page.locator('(//span[normalize-space(text())="Operations & Maintenance"]/following::input)[3]').click();
        await pageFixture.page.waitForTimeout(6000);
        await pageFixture.page.mouse.click(x, y); // Random click based on generated coordinates
       ...
       await pageFixture.page.locator('(//div[@class="dx-datagrid-group-closed"])[4]').click();
       await pageFixture.page.locator('(//div[@class="dx-datagrid-group-closed"])[4]').click();
         await pageFixture.page.waitForTimeout(1000);
     ...
     await pageFixture.page.locator('(//label[normalize-space(text())="Item Description"]/following::textarea)[1]').fill("Test Text");
     await pageFixture.page.waitForTimeout(1000);
     await pageFixture.page.locator('//label[normalize-space(text())="Item Text"]/following::textarea').click();
     await pageFixture.page.locator('//label[normalize-space(text())="Item Text"]/following::textarea').clear();
     await pageFixture.page.locator('//label[normalize-space(text())="Item Text"]/following::textarea').fill("Test Item Data");
     await pageFixture.page.waitForTimeout(1000);
    ...
    When('User Duplicate a Item Text', async () => {
          const randomStr = generateRandomString(10);
        ...
        When('User Delete a Item Text', async () => {
            const randomStr = generateRandomString(10);
