...
(0, cucumber_1.Given)('User is on NH Application Home Page test section', () => __awaiter(void 0, void 0, void 0, function* () {
...
(0, cucumber_1.When)('User Navigates to Project Screen', () => __awaiter(void 0, void 0, void 0, function* () {
    yield pageFixture_1.pageFixture.page.waitForTimeout(2000);
    yield pageFixture_1.pageFixture.page.goto(data.Projectscreen);
}));
(0, cucumber_1.When)('User Creates a Section', () => __awaiter(void 0, void 0, void 0, function* () {
...
(0, cucumber_1.When)('User Update a Section', () => __awaiter(void 0, void 0, void 0, function* () {
    const randomStr = generateRandomString(10);
    yield pageFixture_1.pageFixture.page.locator('//div[@aria-label="Search"]//div[1]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('//span[normalize-space(text())="Export to Excel"]/following::input').click();
    yield pageFixture_1.pageFixture.page.locator('//span[normalize-space(text())="Export to Excel"]/following::input').fill('ABC');
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    ...
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('//span[text()="Show details"]/following-sibling::div').click();
    yield pageFixture_1.pageFixture.page.locator('(//label[normalize-space(text())="Number"]/following::input)[1]').click();
    yield pageFixture_1.pageFixture.page.locator('(//label[normalize-space(text())="Number"]/following::input)[1]').fill('2');
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('//label[normalize-space(text())="Description"]/following::textarea').click();
    yield pageFixture_1.pageFixture.page.locator('//label[normalize-space(text())="Description"]/following::textarea').fill('ABC ' + randomStr);
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('(//label[normalize-space(text())="WBS Level"]/following::input)[1]').click();
    yield pageFixture_1.pageFixture.page.locator('(//label[normalize-space(text())="WBS Level"]/following::input)[1]').fill('13');
    yield pageFixture_1.pageFixture.page.locator('(//input[@role="spinbutton"])[1]').click();
    yield pageFixture_1.pageFixture.page.locator('(//input[@role="spinbutton"])[1]').fill('25');
    yield pageFixture_1.pageFixture.page.locator('//input[@placeholder="/m/week"]').click();
    yield pageFixture_1.pageFixture.page.locator('//div[normalize-space(text())="1000"]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('(//label[normalize-space(text())="Organization"]/following::input)[2]').click();
    yield pageFixture_1.pageFixture.page.locator('//div[normalize-space(text())="04. Lands"]').click();
    yield pageFixture_1.pageFixture.page.locator('//span[normalize-space(text())="Save"]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(18000);
}));
(0, cucumber_1.When)('User Duplicate a Section', () => __awaiter(void 0, void 0, void 0, function* () {
    const randomStr = generateRandomString(10);
    yield pageFixture_1.pageFixture.page.locator('//div[@aria-label="Search"]//div[1]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('//span[normalize-space(text())="Export to Excel"]/following::input').click();
...
(0, cucumber_1.When)('User Delete a Section', () => __awaiter(void 0, void 0, void 0, function* () {
    const randomStr = generateRandomString(10);
    yield pageFixture_1.pageFixture.page.locator('//div[@aria-label="Search"]//div[1]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(1000);
    yield pageFixture_1.pageFixture.page.locator('//span[normalize-space(text())="Export to Excel"]/following::input').click();
    ...
    yield pageFixture_1.pageFixture.page.locator('//div[normalize-space(text())="Confirm Delete"]');
    yield pageFixture_1.pageFixture.page.locator('//div[@data-test-id="GenericModal-destructive-Delete-100-40"]//div[1]').click();
    yield pageFixture_1.pageFixture.page.waitForTimeout(12000);
}));
